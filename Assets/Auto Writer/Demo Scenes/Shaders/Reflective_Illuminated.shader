...
Shader "TEXTOR/Reflective_Illuminated"
{
	Properties 
	{
_Colour("_Colour", Color) = (0.9779412,0.5164442,0.2660576,1)
...
_Rim_Power("_Rim_Power", Range(0,5) ) = 0.86
_Rim_Colour("_Rim_Colour", Color) = (0,0.4206896,1,1)
...
float4 Subtract0=_Colour - Multiply6;
float4 Add2=Subtract0 + Subtract0;
...
float4 Multiply4_0_NoInput = float4(0,0,0,0);
float4 Multiply4=Multiply4_0_NoInput * Multiply0;
float4 Add3=Add2 + Multiply4;
float4 Multiply3_1_NoInput = float4(0,0,0,0);
float4 Multiply3=_Gloss.xxxx * Multiply3_1_NoInput;
float4 Multiply2_1_NoInput = float4(0,0,0,0);
float4 Multiply2=_Spec * Multiply2_1_NoInput;
